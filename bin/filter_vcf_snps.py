...
s5 = 'A/J' 		# A_J
s6 = 'BALB/cJ'		# BALB_cJ 
s7 = 'BTBR Ti<+> Itpr3i<tf>/J'	# BTBR_T+_Itpr3tf_J 
s8 = 'BUB/BnJ' 		# BUB_BnJ
s9 = 'C3H/HeH' 		# C3H_HeH
s10 = 'C3H/HeJ' 	# C3H_HeJ
...
# for the dbsnpload input
inputFileDict = {}
# vcf format for help in testing
vcfFileDict = {}
...
def writeLog():
    ...
    fpLog.write('Total strain alleles with genotype quality = 0: %s' % fi0Ct)
    fpLog.write('Total strain heterozygous strain alleles with genotype quality = 1: %s' % fi1hetCt)
    fpLog.write('Counts of RS by Chromosome\n')
    for c in rsCtByChrDict:
	fpLog.write('chr%s: %s' % (c, rsCtByChrDict[c]))
    return 0
